...
public class Activity_Start extends ActivityKeepBluetooth implements View.OnClickListener{
    ...
    public void onClick(View v) {
            if(v.getId() == R.id.get_started_button){
                Intent intent = new Intent(this, com.joaoaraujo.mindX_android.Activity_Menu.class);
